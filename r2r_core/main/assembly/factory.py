...
from r2r_core.agent import R2RRAGAgent, R2RStreamingRAGAgent
...
from r2r_core.pipelines import (
    IngestionPipeline,
...
class R2RProviderFactory:
    ...
    def create_auth_provider(
        ...
        **kwargs,
        ...
        if auth_config.provider == "r2r":
            from r2r_core.providers import R2RAuthProvider
    ...
    def create_crypto_provider(
        ...
        if crypto_config.provider == "bcrypt":
            from r2r_core.providers.crypto import BCryptConfig, BCryptProvider
    ...
    def create_parsing_provider(
        ...
        if parsing_config.provider == "r2r":
            ...
            from r2r_core.providers import UnstructuredParsingProvider
    ...
    def create_chunking_provider(
        ...
        if chunking_config.provider == "r2r":
            from r2r_core.providers import R2RChunkingProvider
    ...
    def create_llm_provider(
        ...
        if llm_config.provider == "openai":
            from r2r_core.providers import OpenAICompletionProvider

            llm_provider = OpenAICompletionProvider(llm_config)
        elif llm_config.provider == "litellm":
            from r2r_core.providers import LiteCompletionProvider
    ...
    def create_prompt_provider(
        ...
        if prompt_config.provider == "r2r":
            from r2r_core.providers import R2RPromptProvider
    ...
    def create_kg_provider(kg_config, *args, **kwargs):
        if kg_config.provider == "neo4j":
            from r2r_core.providers import Neo4jKGProvider
...
class R2RPipeFactory:
    ...
    def create_embedding_pipe(self, *args, **kwargs) -> Any:
        ...
        from r2r_core.pipes import EmbeddingPipe
    ...
    def create_vector_storage_pipe(self, *args, **kwargs) -> Any:
        ...
        from r2r_core.pipes import VectorStoragePipe
    ...
    def create_vector_search_pipe(self, *args, **kwargs) -> Any:
        ...
        from r2r_core.pipes import VectorSearchPipe
    ...
    def create_kg_pipe(self, *args, **kwargs) -> Any:
        ...
        from r2r_core.pipes import KGTriplesExtractionPipe
    ...
    def create_kg_storage_pipe(self, *args, **kwargs) -> Any:
        ...
        from r2r_core.pipes import KGStoragePipe
    ...
    def create_kg_search_pipe(self, *args, **kwargs) -> Any:
        ...
        from r2r_core.pipes import KGSearchSearchPipe
    ...
    def create_rag_pipe(self, stream: bool = False, *args, **kwargs) -> Any:
        if stream:
            from r2r_core.pipes import StreamingSearchRAGPipe
            ...
            from r2r_core.pipes import SearchRAGPipe
    ...
    def create_kg_node_extraction_pipe(self, *args, **kwargs) -> Any:
        from r2r_core.pipes import KGNodeExtractionPipe
    ...
    def create_kg_node_description_pipe(self, *args, **kwargs) -> Any:
        from r2r_core.pipes import KGNodeDescriptionPipe
    ...
    def create_kg_clustering_pipe(self, *args, **kwargs) -> Any:
        from r2r_core.pipes import KGClusteringPipe
