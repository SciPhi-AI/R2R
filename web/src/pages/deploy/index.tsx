  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          To deploy a new Pipeline, import an existing GitHub Repository or select a template.
        </CardDescription>
      </CardHeader>
      <CardFooter>
            ...
            <div className="col-span-8 left-content">
                <div className="mb-8">
                    <div className="space-y-2">
                        ...
                        <Input placeholder="Name Your Pipeline" className="w-full" onChange={(e) => setPipelineName(e.target.value)} value={pipelineName} />
                    </div>
                    <div className="space-y-2 mt-1">
                        <Label htmlFor="github-url"  >GitHub URL</Label>
                        <Input key="github-url" id="github-url" placeholder="Enter your GitHub URL" className="w-full" onChange={(e) => setGithubUrl(e.target.value)} value={githubUrl} />
                    </div>
                </div>
                ...
                {secretPairs.map((pair, index) => (
                    ...
                    <div className="col-span-5 space-y-2">
                        {index === 0 && <Label htmlFor={`secret-key-${index + 1}`}>Secret Key(s)</Label>}
                        <Input
                        id={`secret-key-${index + 1}`}
                        placeholder="e.g. `OPENAI_API_KEY`"
                        value={pair.key}
                        onChange={(e) => handleSecretKeyChange(index, e.target.value)}
                        />
                    </div>
                    <div className="col-span-6 space-y-2">
                        {index === 0 && <Label htmlFor={`secret-value-${index + 1}`}>Secret Value(s)</Label>}
                        <Input
                    ...
                    <div className="col-span-1 flex justify-end">
                        <button
                        className={"bg-red-500 hover:bg-red-700 text-white font-bold py-1 px-2 rounded text-xs " + (index === 0 ? "mt-7" : "")}
                ...
                <div className="space-y-2">
                    ...
                    <TooltipProvider >
                        ...
                        <TooltipContent>
                            <p>
                            Selecting an API key will protect your application during deployment.
                            <br/>
                            API keys enable secure communication between your application and the server. 
                            <br/>
                            <br/>
                            Select `No API Key` to allow unauthenticated access to your application.
                            </p>
                        </TooltipContent>
                        </Tooltip>
                    </TooltipProvider>
                    ...
                    {newPublicKey && (
                        <div className="mt-2">
                            <Label htmlFor="api-key-name">API Key Name (optional)</Label>
                            <Input
                            id="api-key-name"
                    ...
                    <div className="mt-2">
                        ...
                        Warning: Your private key will not be saved. Please store it securely.
                        </p>
                    </div>
                    )}
