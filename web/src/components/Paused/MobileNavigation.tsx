...
// // import { Navigation } from '@/components/Paused/Navigation';
...
//   // Use useState to capture the initial values only once
...
//   // Use useEffect to set the initial values only on component mount
//   useEffect(() => {
