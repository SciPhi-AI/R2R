...
>(function Header({ className }, ref) {
  ...
  return (
    <motion.div
      ...
      className={clsx(
        className,
        'fixed inset-x-0 top-0 z-50 flex h-10 items-center justify-between gap-12 px-4 transition sm:px-6 lg:z-30 lg:px-8 backdrop-blur-sm dark:backdrop-blur bg-zinc-800'
      )}
      style={
        {
