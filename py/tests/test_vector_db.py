...
def sample_entries(vector_db):
    entries = [
        VectorEntry(
            ...
            user_id=uuid4(),
            group_ids=[uuid4()],
            vector=Vector(data=[0.1, 0.2, 0.3]),
            text="Apple",
            metadata={
                "category": "fruit",
                "color": "red",
        ...
        VectorEntry(
            ...
            user_id=uuid4(),
            group_ids=[uuid4()],
            vector=Vector(data=[0.2, 0.3, 0.4]),
            text="Banana",
            metadata={
                "category": "fruit",
                "color": "yellow",
        ...
        VectorEntry(
            ...
            user_id=uuid4(),
            group_ids=[uuid4()],
            vector=Vector(data=[0.3, 0.4, 0.5]),
            text="Carrot",
            metadata={
                "category": "vegetable",
                "color": "orange",
        ...
        VectorEntry(
            ...
            user_id=uuid4(),
            group_ids=[uuid4()],
            vector=Vector(data=[0.4, 0.5, 0.6]),
            text="Durian",
            metadata={
                "category": "fruit",
                "color": "green",
...
def test_search_equality_filter(vector_db, sample_entries):
    query_vector = Vector(data=[0.2, 0.3, 0.4])
...
def test_delete_equality(vector_db, sample_entries):
    ...
    remaining = vector_db.semantic_search(
        Vector(data=[0.2, 0.3, 0.4]).data,
        VectorSearchSettings(search_limit=10),
    )
