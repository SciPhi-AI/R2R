...
def setup_prerequisites():
    ...
    print("Created collection with ID: " + str(collection_result["results"]["collection_id"]))
...
def test_graph_operations(collection_id):
    ...
    print('entities_result["results"]["entities"][0] = ', entities_result["results"]["entities"][0])
    entity_id = entities_result["results"]["entities"][0]["id"] #entities_result['items'][0]['id']
