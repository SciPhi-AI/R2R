...
class MistralOCRProvider(OCRProvider):
    ...
    async def upload_file(self, file_path: str | None = None, file_content: bytes | None = None, file_name: str | None = None) -> Any:
        """
    ...
    async def process_file(self, file_id: str, include_image_base64: bool = False) -> OCRResponse:
        """
        ...
        signed_url = await self.mistral.files.get_signed_url_async(file_id=file_id)
    ...
    async def process_url(self, url: str, is_image: bool = False, include_image_base64: bool = False) -> OCRResponse:
        """
    ...
    async def process_pdf(self, file_path: str | None = None, file_content: bytes | None = None) -> OCRResponse:
        """
        ...
        uploaded_file = await self.upload_file(file_name=file_name, file_content=file_content)
