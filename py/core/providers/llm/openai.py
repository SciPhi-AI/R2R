...
class OpenAICompletionProvider(CompletionProvider):
    def __init__(self, config: CompletionConfig, *args, **kwargs) -> None:
        ...
        # Initialize Azure clients if credentials exist
        ...
        if not any(
            ...
            raise ValueError(
                ...
                "OLLAMA_API_BASE, or LMSTUDIO_API_BASE."
            )

    def _get_client_and_model(self, model: str):
        """Determine which client to use based on model prefix and return appropriate client and model name."""
