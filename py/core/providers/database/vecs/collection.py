...
class Collection:
    ...
    def delete(
        ...
        Args:
            ids (Optional[Iterable[UUID]], optional): An iterable of vector identifiers.
            filters (Optional[Dict], optional): Filters to apply to the search. Defaults to None.

        Returns:
            Dict[str, Dict[str, str]]: A dictionary of deleted records, where the key is the id
            and the value is a dictionary containing 'document_id', 'id', and 'text'.
