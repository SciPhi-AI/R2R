...
class KGSearchSettings(BaseModel):
    ...
    local_search_limits: dict[str, int] = Field(
        ...
        description="The maximum number of results to return for each type of knowledge graph search",
    )
    ...
    class Config:
        ...
        json_schema_extra = {
            ...
            "graphrag_map_system_prompt": "graphrag_map_system_prompt",
            "graphrag_reduce_system_prompt": "graphrag_reduce_system_prompt",
        }
