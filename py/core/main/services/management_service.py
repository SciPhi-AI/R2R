...
class ManagementService(Service):
    ...
    #     # 3) Build the overall (global) "effective limits" ignoring any specific route
    #     overall_effective = self.providers.database.limits_handler.determine_effective_limits(
    #         user, route=""
    #     )
    ...
    #      - The system default limits (from self.config.limits)
    #      - The user's overrides (from user.limits_overrides)
    #      - The final 'effective' set of limits after merging (overall, i.e. ignoring route-specific for the moment)
    #      - The usage for each relevant limit (how many requests used, how many remain, etc.)
    #        including per-route usage.
    #     """
    #     # 1) Fetch the user
    #     user = await self.providers.database.users_handler.get_user_by_id(user_id)
    #     user_overrides = user.limits_overrides or {}

    #     # 2) Grab system defaults (just a dict version of self.config.database.limits)
    #     system_defaults = {
    #         "global_per_min": self.config.database.limits.global_per_min,
    #         "route_per_min": self.config.database.limits.route_per_min,
    #         "monthly_limit": self.config.database.limits.monthly_limit,
    ...
    #     # 3) Build the overall "effective limits" ignoring any specific route
    #     #    (you can pass an empty string or some sentinel if your code
    #     #     merges route-specific overrides only if route is found).
    #     overall_effective = self.providers.database.limits_handler.determine_effective_limits(
    #         user, route=""
    #     )
    ...
    #         "limit": overall_effective.monthly_limit,
    #         "remaining": (
    #             overall_effective.monthly_limit - monthly_used
    #             if overall_effective.monthly_limit is not None
    #             else None
    #         ),
    #     }
    ...
    #             user_id, route, one_min_ago
    #         )
    #         # 3) For monthly usage, we’re reusing the total monthly usage. If you want per-route monthly usage,
    #         #    you'll need a route-specific monthly counter. For now, we reuse `monthly_used`.
    ...
    #                 ),
    #             },
    #             # If you want route-specific monthly usage, you'd do a route-based query in your limits handler.
    #             # For now, we just show how the route's monthly limit compares to the user's total monthly usage.
    #             "monthly_limit": {
    #                 "used": monthly_used,
    #                 "limit": route_effective.monthly_limit,
    #                 "remaining": (
    #                     route_effective.monthly_limit - monthly_used
    #                     if route_effective.monthly_limit is not None
    #                     else None
    #                 ),
    #             },
    ...
    #     # 5) Return a structured response including:
    #     #     - The system default limits
    #     #     - The raw user_overrides
    #     #     - The final "effective" overall limits (no route)
    #     #     - Usage details for global + monthly + per-route
    #     result = {
    #         "system_defaults": system_defaults,
    #         "user_overrides": user_overrides,
    #         "effective_limits": {
    ...
    # #         )
    # #         route_route_per_min = self._count_requests
    # #         # (
