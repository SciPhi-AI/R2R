    ...
    "x-codeSamples": [
        ...
        },
        {
            ...
            "source": textwrap.dedent(
                """
                # Basic search
                curl -X POST "http://20.55.204.62:7272/v3/retrieval/search" \\
    ...
    "x-codeSamples": [
        ...
        },
        {
            ...
            "source": textwrap.dedent(
                """
                # Basic RAG request
                curl -X POST "http://20.55.204.62:7272/v3/retrieval/rag" \\
                    -H "Content-Type: application/json" \\
                    -H "Authorization: Bearer YOUR_API_KEY" \\
                    -d '{
                    "query": "What is DeepSeek R1?"
...
"""
        ...
        },
        {
            ...
            "source": textwrap.dedent(
                """
                # Basic request
                curl -X POST "http://20.55.204.62:7272/v3/retrieval/agent" \\
                    -H "Content-Type: application/json" \\
                    -H "Authorization: Bearer YOUR_API_KEY" \\
                    -d '{
                    "message": {
...
completion_examples = {
    "x-codeSamples": [
        ...
        },
        {
            ...
            "source": textwrap.dedent(
                """
                curl -X POST "http://20.55.204.62:7272/v3/retrieval/completion" \\
                    -H "Content-Type: application/json" \\
                    -H "Authorization: Bearer YOUR_API_KEY" \\
                    -d '{
                    "messages": [
...
embedding_examples = {
    "x-codeSamples": [
        ...
        },
        {
            ...
            "source": textwrap.dedent(
                """
                curl -X POST "http://20.55.204.62:7272/v3/retrieval/embedding" \\
                    -H "Content-Type: application/json" \\
                    -H "Authorization: Bearer YOUR_API_KEY" \\
                    -d '{
                    "text": "What is DeepSeek R1?",
...
```json
{
  "model": "azure/gpt-4o-mini",  // Model to use
