    ...
    def _setup_routes(self):
        ...
        async def register(
            ...
            bio: str | None = Body(None,
                                   description="The bio for the new user"),
        ...
        async def verify_email(
            ...
            user = (
                await
                self.providers.database.users_handler.get_user_by_email(email))
        ...
        async def send_verification_email(
            ...
            return GenericMessageResponse(
                message="A verification email has been sent.")  # type: ignore
        ...
        async def login(
            ...
            return await self.services.auth.login(form_data.username,
                                                  form_data.password)
        ...
        async def list_users(
            ...
            users_overview_response = (await
                                       self.services.management.users_overview(
                                           user_ids=user_uuids,
                                           offset=offset,
                                           limit=limit))
        ...
        async def list_user_api_keys(
            ...
            keys = (
                await
                self.providers.database.users_handler.get_user_api_keys(id))
        ...
        async def delete_user_api_key(
            ...
            success = (await
                       self.providers.database.users_handler.delete_api_key(
                           id, key_id))
            if not success:
                raise R2RException("API key not found or could not be deleted",
                                   400)
        ...
        @self.router.get(
            ...
            responses={
                ...
                403: {
                    "description":
                    "If the requesting user is neither the same user nor a superuser."
                },
                404: {
                    "description": "If the user ID does not exist."
                },
            },
            openapi_extra={
                "x-codeSamples": [
        ...
        async def get_user_limits(
            ...
            limits_info = await self.services.management.get_all_user_limits(id
                                                                             )
        ...
        async def google_authorize() -> WrappedGenericMessageResponse:
            ...
            return GenericMessageResponse(
                message=google_auth_url)  # type: ignore
        ...
        async def github_authorize() -> WrappedGenericMessageResponse:
            ...
            return GenericMessageResponse(
                message=github_auth_url)  # type: ignore
        ...
        async def github_callback(code: str = Query(...),
            ...
            github_id = str(
                user_info_resp["id"])  # GitHub user ID is typically an integer
