...
# #     async def transform_fragments(
# #         self, fragments: AsyncGenerator[Fragment, None]
# #     ) -> AsyncGenerator[Fragment, None]:
# #         """
# #         Transforms text chunks based on their metadata, e.g., adding prefixes.
# #         """
...
# #                 yield fragment
# #             except Exception as e:
# #                 logger.error(f"Error transforming fragment: {e}")
# #                 yield R2RDocumentProcessingError(
# #                     str(e), fragment.document_id
# #                 )
...
# #     async def _process_batch(
# #         self, fragment_batch: list[Fragment]
# #     ) -> list[Union[VectorEntry, R2RDocumentProcessingError]]:
# #         try:
# #             vectors = await self.embed(fragment_batch)
# #             return [
# #                 VectorEntry(
...
# #         except Exception as e:
# #             logger.error(f"Error processing batch: {e}")
# #             return [R2RDocumentProcessingError(str(e), fragment.document_id)
...
# #             fragment_batch = []
# #             async for item in self.transform_fragments(
# #                 self.fragment(extraction, run_id)
# #             ):
