...
yc_extraction_notes = """
Notes:\n  - For this specific task, you are working with company data from the YC directory. You sould seek to extract as many details about the company as possible (name, founders, CEO/CTO/..., URLs, group partner, YC batch (S23, W24, ..), key tags (b2b, developer tools, artificial intelligence), emails, etc.\n\n### Response:\n
"""
...
if __name__ == "__main__":
    ...
    # -- USE WITH CARE -- this will delete all entries in the graph
    ...
    for company, url in url_map.items():
        ...
        print("text = ", fetch_and_clean_yc_co_data(url))
...
#     [
#         Document(
#             id=generate_id_from_label('airbnb'),
#             type="txt",
#             data=input_text,
#             metadata={},
#         )
