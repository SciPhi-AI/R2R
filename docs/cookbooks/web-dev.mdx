...
description: 'Learn how to build webapps powered by RAG using R2R'
icon: 'window'
---
...
For more extensive reference and examples of how to use te r2r-js library, we encourage you to look at the [R2R Application](/cookbooks/application) and its source code.
