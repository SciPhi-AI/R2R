...
<Warning>
Local installation of R2R can be difficult / challenging due to the many services which R2R integrates. Use Docker to get started quickly.
</Warning>
