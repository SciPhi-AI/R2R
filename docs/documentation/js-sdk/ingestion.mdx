...
<ParamField path="options" type="object">
  ...
  <ParamField path="chunking_config" type="Record<string, any>">
    ...
    Which chunking provider to use, select from `r2r`, `unstructured_local`, and `unstructured_api`.
    </ParamField>

    <ParamField path="method" type="str" default="by_title">
    Which chunking method to apply? When using unstructured, `by_title` or `basic` are supported by unstructured.
    </ParamField>
