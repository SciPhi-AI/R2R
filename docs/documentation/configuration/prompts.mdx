...
| [`graphrag_map_system_prompt.yaml`](https://github.com/SciPhi-AI/R2R/blob/main/py/core/providers/prompts/defaults/graphrag_map_system_prompt.yaml) | System prompt for the "map" phase in GraphRAG, likely used to process individual nodes or edges. |
| [`graphrag_reduce_system_prompt.yaml`](https://github.com/SciPhi-AI/R2R/blob/main/py/core/providers/prompts/defaults/graphrag_reduce_system_prompt.yaml) | System prompt for the "reduce" phase in GraphRAG, used to combine or summarize information from multiple sources. |
| [`graphrag_triplet_extraction_few_shot.yaml`](https://github.com/SciPhi-AI/R2R/blob/main/py/core/providers/prompts/defaults/graphrag_triplet_extraction_few_shot.yaml) | Few-shot prompt for extracting subject-predicate-object triplets in GraphRAG, with examples. |
| [`graphrag_triplet_extraction_zero_shot.yaml`](https://github.com/SciPhi-AI/R2R/blob/main/py/core/providers/prompts/defaults/graphrag_triplet_extraction_zero_shot.yaml) | Zero-shot prompt for extracting subject-predicate-object triplets in GraphRAG, without examples. |
| [`hyde.yaml`](https://github.com/SciPhi-AI/R2R/blob/main/py/core/providers/prompts/defaults/hyde.yaml) | Likely related to Hypothetical Document Embeddings (HyDE) for improving retrieval performance. |
| [`kg_search.yaml`](https://github.com/SciPhi-AI/R2R/blob/main/py/core/providers/prompts/defaults/kg_search.yaml) | Used for searching the knowledge graph, possibly to formulate queries or interpret results. |
| [`kg_search_with_spec.yaml`](https://github.com/SciPhi-AI/R2R/blob/main/py/core/providers/prompts/defaults/kg_search_with_spec.yaml) | Similar to `kg_search.yaml`, but with a specific schema or specification for the search process. |
| [`rag_agent.yaml`](https://github.com/SciPhi-AI/R2R/blob/main/py/core/providers/prompts/defaults/rag_agent.yaml) | Defines the behavior and instructions for the RAG agent, which coordinates the retrieval and generation process. |
| [`rag_context.yaml`](https://github.com/SciPhi-AI/R2R/blob/main/py/core/providers/prompts/defaults/rag_context.yaml) | Likely used to process or format the context retrieved for RAG tasks. |
...
R2R uses a `R2RPromptProvider` class to manage prompts. This provider handles the storage, retrieval, and manipulation of prompts, leveraging both a PostgreSQL database and YAML files for flexibility and persistence.
