...
> Based on the provided context from the Lyft 2021 report, it appears that the customer segments that grew the fastest for Lyft were the Active Riders. The report mentions efforts to grow and recoup the rider base amid the COVID-19 pandemic, as well as an increase in ride sampling_fraction and revenue per Active Rider. This indicates that the Active Riders segment experienced significant growth during the period covered in the report.
```
