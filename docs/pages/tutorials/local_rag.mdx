...
Note, this requires you to have downloaded `tinyllama-1.1b-chat-v1.0.Q2_K.gguf` from [here](https://huggingface.co/TheBloke/TinyLlama-1.1B-Chat-v1.0-GGUF/resolve/main/tinyllama-1.1b-chat-v1.0.Q2_K.gguf?download=true) and placed the output into `~/cache/model/`.
