...
**Starting the a server**:
   ...
   r2r.core.providers.vector_db_provider - INFO - Initializing VectorDBProvider with config extra_fields={} provider='local' collection_name='demo_vecs'. - 2024-06-16 14:55:59,291
   r2r.providers.embeddings.openai.openai_base - INFO - Initializing `OpenAIEmbeddingProvider` to provide embeddings. - 2024-06-16 14:55:59,295
   Python-dotenv could not parse statement starting at line 14
   Python-dotenv could not parse statement starting at line 14
   Python-dotenv could not parse statement starting at line 14
   r2r.core.providers.llm_provider - INFO - Initializing LLM provider with config: extra_fields={} provider='litellm' - 2024-06-16 14:55:59,860
   r2r.pipes.parsing_pipe - INFO - Initializing a `ParsingPipe` to parse incoming documents. - 2024-06-16 14:55:59,860
   r2r.core.pipes.base_pipe - INFO - Initialized pipe default_document_parsing_pipe of type PipeType.INGESTOR - 2024-06-16 14:55:59,860
   r2r.core.pipes.base_pipe - INFO - Initialized pipe default_embedding_pipe of type PipeType.INGESTOR - 2024-06-16 14:56:00,105
   r2r.pipes.vector_storage_pipe - INFO - Initalizing an `AsyncVectorStoragePipe` to store embeddings in a vector database. - 2024-06-16 14:56:00,105
   r2r.core.pipes.base_pipe - INFO - Initialized pipe default_loggable_pipe of type PipeType.INGESTOR - 2024-06-16 14:56:00,105
   r2r.core.pipes.base_pipe - INFO - Initialized pipe default_vector_search of type PipeType.SEARCH - 2024-06-16 14:56:00,105
   r2r.core.pipes.base_pipe - INFO - Initialized pipe default_rag_pipe of type PipeType.GENERATOR - 2024-06-16 14:56:00,105
   r2r.core.pipes.base_pipe - INFO - Initialized pipe default_streaming_rag_pipe of type PipeType.GENERATOR - 2024-06-16 14:56:00,105
   r2r.core.pipes.base_pipe - INFO - Initialized pipe default_eval_pipe of type PipeType.EVAL - 2024-06-16 14:56:00,105
