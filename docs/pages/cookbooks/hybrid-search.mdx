...
```bash filename="bash" copy
python -m r2r.examples.quickstart search --query="What is a fierce nerd?" --client_server_mode
```
...
python -m r2r.examples.quickstart search --query="What is a fierce nerd?" --client_server_mode  --do_hybrid_search
```
