...
#### Navigation
When running R2R with knowledge graphs enabled, ingested documents and files will automatically have named entities and relationships extracted and stored. Let's explicitly confirm that this was the case:
...
Executing the following demonstrates both functionalities:
