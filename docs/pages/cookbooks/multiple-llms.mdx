...
Leveraging multiple language models (LLMs) in R2R allows for a diverse and comprehensive approach to search and retrieval tasks. By incorporating multiple LLMs, you can benefit from the unique strengths and specializations of each model, leading to improved accuracy, relevance, and contextual understanding of the search results.
...
This guide assumes R2R is installed and the [quickstart located here](/getting-started/quickstart) has been completed.
