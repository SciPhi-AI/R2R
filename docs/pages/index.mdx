...
## Quickstart
The [R2R Quickstart](/getting-started/quickstart) provides a step-by-step guide to running the default R2R Retrieval-Augmented Generation (RAG) backend. The guide ingests the provided documents and illustrates search and RAG functionality, logging, analytics, and document management.
