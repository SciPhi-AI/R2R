...
## Demo(s)
The [R2R Quickstart](/getting-started/quickstart) provides a step-by-step guide to running the default R2R Retrieval-Augmented Generation (RAG) backend. The demo ingests the provided documents and illustrates search and RAG functionality, logging, analytics, and document management.
...
- [R2R Quickstart](/getting-started/quickstart): A basic demo script designed to get you started with an R2R RAG application. 
- [R2R Client-Server](/cookbooks/client-server): An extension of the basic `R2R Quickstart` with client-server interactions.
