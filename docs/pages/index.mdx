...
- [Local RAG](/cookbooks/local_rag): A quick cookbook demonstration of how to run R2R with local LLMs.
- [Hybrid Search](/cookbooks/hybrid_search): A brief introduction to running hybrid search with R2R.
- [Reranking](/cookbooks/rerank_search): A short guide on how to apply reranking to R2R results.
