...
```bash
poetry run python -m r2r.examples.demo search --query="What is shown on the user screen?"
```
...
```bash
poetry run python -m r2r.examples.demo evaluate
```
...
```bash
poetry run python -m r2r.examples.demo get_logs
```
