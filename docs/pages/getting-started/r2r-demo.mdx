...
![R2R App Architecture](docs/pages/getting-started/r2r_demo_architecture.png "R2R App Architecture")
...
Afterwards, we may confirm complete user documentation through the `get_user_document_metadata` functionality.
