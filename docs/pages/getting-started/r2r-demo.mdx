...
The R2R demo offers a step-by-step walkthrough of the core features provided by R2R. The framework includes a REST API for document ingestion, RAG, evaluation, and supporting features like observability and document management.

The demo begins with ingesting a list of provided documents and showcases search, RAG, and more advanced functionalities. The script powering the demo, [`r2r/examples/demo.py`](https://github.com/SciPhi-AI/R2R/blob/main/r2r/examples/demo.py), can be configured and extended to fit your specific use case.
