...
```bash
poetry run python r2r/examples/demo.py ingest_as_files
```
...
```bash
poetry run python r2r/examples/demo.py get_user_document_data --user_id="063edaf8-3e63-4cb9-a4d6-a855f36376c3"
```
...
{'results': [{'document_id': '327f6110-edd1-5fe3-b6b3-49b55f1cbc28', 'title': 'pg_essay_3.html'}, {'document_id': '946859f0-da5c-5db7-9b5c-c586be76d709', 'title': 'pg_essay_5.html'}, {'document_id': '64c1c913-be06-548f-acbc-3618b00d3616', 'title': 'lyft_2021.pdf'}, {'document_id': '766082fd-bde4-561a-b27e-63b811056efb', 'title': 'pg_essay_4.html'}, {'document_id': '888591ba-2639-5fe7-b617-395d640c1910', 'title': 'pg_essay_1.html'}, {'document_id': '8d78f34d-f795-5c82-a90f-18b8cc3a883c', 'title': 'uber_2021.pdf'}, {'document_id': '5d3a25d3-0933-54d5-a4e2-0434a069e578', 'title': 'pg_essay_2.html'}, {'document_id': 'dd8ed784-4826-523b-9c24-93409cea93f7', 'title': 'screen_shot.png'}]}
...
```
...
```bash
poetry run python r2r/examples/demo.py search --query="Who was Aristotle?"
```
...
{'id': UUID('93c44e73-8e95-50c2-84af-6a42f070b552'), 'score': 0.7739712385010018, 'metadata': {'document_id': '15255e98-e245-5b58-a57f-6c51babf72dd', 'extraction_id': '5c61f9b9-b468-5fd7-8eb1-5d797a15c484', 'text': 'Aristotle[A] (Greek: Ἀριστοτέλης Aristotélēs, pronounced [aristotélɛːs]; 384–322 BC) was an Ancient Greek philosopher and polymath. His writings cover a broad range of subjects spanning the natural sciences, philosophy, linguistics, economics, politics, psychology, and the arts. As the founder of the Peripatetic school of philosophy in the Lyceum in Athens, he began the wider Aristotelian tradition that followed, which set the groundwork for the development of modern science.', 'title': 'aristotle.txt', 'user_id': '063edaf8-3e63-4cb9-a4d6-a855f36376c3', 'query': 'Who was Aristotle?'}}
{'id': UUID('a3da125c-cf13-58df-a470-6d9df9ff22d3'), 'score': 0.6876935337857121, 'metadata': {'document_id': '15255e98-e245-5b58-a57f-6c51babf72dd', 'extraction_id': '5c61f9b9-b468-5fd7-8eb1-5d797a15c484', 'text': 'Aristotle was revered among medieval Muslim scholars as "The First Teacher", and among medieval Christians like Thomas Aquinas as simply "The Philosopher", while the poet Dante called him "the master of those who know". His works contain the earliest known formal study of logic, and were studied by medieval scholars such as Peter Abelard and Jean Buridan. Aristotle\'s influence on logic continued well into the 19th century. In addition, his ethics, although always influential, gained renewed interest with', 'title': 'aristotle.txt', 'user_id': '063edaf8-3e63-4cb9-a4d6-a855f36376c3', 'query': 'Who was Aristotle?'}}
{'id': UUID('c7da6421-25c2-5d12-808f-8c5ce4091d12'), 'score': 0.6620316195257511, 'metadata': {'document_id': '15255e98-e245-5b58-a57f-6c51babf72dd', 'extraction_id': '5c61f9b9-b468-5fd7-8eb1-5d797a15c484', 'text': "Aristotle was born in 384 BC[C] in Stagira, Chalcidice,[2] about 55 km (34 miles) east of modern-day Thessaloniki.[3][4] His father, Nicomachus, was the personal physician to King Amyntas of Macedon. While he was young, Aristotle learned about biology and medical information, which was taught by his father.[5] Both of Aristotle's parents died when he was about thirteen, and Proxenus of Atarneus became his guardian.[6] Although little information about Aristotle's childhood has survived, he probably spent", 'title': 'aristotle.txt', 'user_id': '063edaf8-3e63-4cb9-a4d6-a855f36376c3', 'query': 'Who was Aristotle?'}}
...
```
...
```bash
poetry run python r2r/examples/demo.py rag --query="What was Ubers profit in 2020?"
```
...
```bash
poetry run python r2r/examples/demo.py rag --query="What was Lyfts profit in 2020?" --streaming=True
```
...
```bash
poetry run python r2r/examples/demo.py delete --key=document_id --value=15255e98-e245-5b58-a57f-6c51babf72dd
```
...
# poetry run python r2r/examples/demo.py delete --key=user_id --value=063edaf8-3e63-4cb9-a4d6-a855f36376c3
```
...
```bash
poetry run python r2r/examples/demo.py search --query="What is shown on the user screen?"
```
...
```bash
poetry run python r2r/examples/demo.py evaluate
```
