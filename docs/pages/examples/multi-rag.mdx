...
The `SyntheticRAGPipeline` is a subclass of `QnARAGPipeline` that overrides the basic RAG pipeline logic to include synthetic query generation and aggregation. Here's an example implementation:
