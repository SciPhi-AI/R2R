...
```bash
# Perform a search
python -m r2r.examples.pdf_chat.run_demo search "what is the meditations about?"
...
python -m r2r.examples.pdf_chat.run_demo rag_completion "what is the meditations about?"
