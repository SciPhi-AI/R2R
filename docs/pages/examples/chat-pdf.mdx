...
```bash
# Perform a search
poetry run python -m r2r.examples.pdf_chat.run_demo search "what is the meditations about?"
...
poetry run python -m r2r.examples.pdf_chat.run_demo rag_completion "what is the meditations about?"
# {
#  ...
