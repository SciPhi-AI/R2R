...
R2R includes a set of factories that allow for the creation and customization of various components required to build and run an `R2RApp`. These factories are integral to R2R, providing flexibility and extensibility in how components are instantiated and configured.
