...
The **VectorStoragePipe** stores the generated embeddings in a vector database. It handles batch storage operations efficiently using asynchronous processing.
