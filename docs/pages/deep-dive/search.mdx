...
The **R2RVectorSearchPipe** performs vector-based searches using an embedding provider and a vector database provider.
...
```python
from r2r import SearchPipeline, R2RConfig, R2RProviderFactory, R2RPipeFactory, R2RPipelineFactory, R2RQueryTransformPipe, GenerationConfig, run_pipeline
