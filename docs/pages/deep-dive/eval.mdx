...
- `logging_connection` (optional): An instance of `LoggingDatabaseConnectionSingleton` for logging.
...
from r2r.core import EvalPipeline, LoggingDatabaseConnectionSingleton, log_execution_to_db
