...
def r2r_app():
    ...
    try:
        ...
        PipeLoggingConnectionSingleton._config.logging_path = config.logging.logging_path
...
async def test_ingest_and_search_larger_txt_file(r2r_app, logging_connection):
        ...
        assert "was an Ancient Greek philosopher and polymath" in search_results['results'][0].metadata['text']